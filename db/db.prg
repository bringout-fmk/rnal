...
if (nArea==-1 .or. nArea == nArea2)
	...
	do case 
		...
		case (nArea2 == F_RNAL) 
			...
			CREATE_INDEX("dat_nal", "DTOS(datnal)+STR(br_nal,10,0)+STR(r_br,4,0)", cPath + cTable)
			CREATE_INDEX("dat_isp", "DTOS(datisp)+STR(br_nal,10,0)+STR(r_br,4,0)", cPath + cTable)
